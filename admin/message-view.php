    ...
    <div class="div">
        <div class="col-lg-12 ">
          ...
          echo "<a class='button logout' href ='m_delete.php?id=$id' onClick=\"javascript:return confirm ('Are you really want to delete ?');\">Delete</a>";
           ?>
           <?php
          echo "<a class='button logout' href ='m_close.php?id=$id' onClick=\"javascript:return confirm ('Are you really want to Close the complain ?');\">Close Complain</a>";
           ?>
           <br><br><br><br>
          <table>
          <?php
          ...
          <div class="field-off jumbotron">
            <br>
            <h2>Faculties</h2>
            <p>Note : Click on the faculty name so he/she can help with that problem </p>
